    ...
    <div>
      ...
      <section v-else >
        <div class="card dark-grey">
          <div v-for="cat of categories" :key="cat.id" class="card-content ">
            <p>
              <strong class="white-text">{{cat.title}}:</strong>
              <span class="white-text">{{cat.spend | currency}} {{'Of'|localize}} {{cat.limit | currency}}</span>
            </p>
